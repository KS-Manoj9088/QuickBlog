  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
            ...
            <form className='flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300 bg-white rounded overflow-hidden' onSubmit={onSubmitHandler}>
                <input type="text" placeholder='Search for blogs' required
                 className='w-full pl-4 outline-none' ref={inputRef}/>
      ...
      <div className='text-center'>
        {input && <button 
        className='border font-light text-xs py-1 px-3 rounded-sm shadow-custom-sm cursor-pointer' onClick={onClear}>
          Clear Search
        </button>}
      </div>
